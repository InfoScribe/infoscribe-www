...
app.get('/projects', routes.project.getProjects);
app.get('/project/new', routes.passport.isAuthenticated, routes.project.getNewProject);
app.post('/project/new', routes.passport.isAuthenticated, routes.project.postNewProject);
app.get('/project/edit/:id', routes.passport.isAuthenticated, routes.project.getEditProject);
app.post('/project/edit/:id', routes.passport.isAuthenticated, routes.project.postEditProject);
app.get('/project/:id/:slug', routes.project.getProject);
app.get('/project/:id', routes.project.getProject);
